...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/60114d68e1ff2000159dccee
...
To start editing your site, you can use the Sanity interface at https://thoughtful-zebra-14d68.sanity.studio/.
...
Generated at `2021-01-27T11:27:36.609Z` by Stackbit version `0.3.44`.